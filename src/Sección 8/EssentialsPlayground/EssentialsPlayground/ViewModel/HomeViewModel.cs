...
using EssentialsPlayground.Model;
using EssentialsPlayground.View;
...
namespace EssentialsPlayground.ViewModel
{
	public class HomeViewModel : BaseViewModel
	{
		...
		SampleItem[] EssentialsPlayground;
		...
		public HomeViewModel()
		{
			...
			EssentialsPlayground = new SampleItem[]
			{
				new SampleItem(
					"📏",
					"Accelerometer",
			...
			filteredItems = EssentialsPlayground;
		...
		public string FilterText
		{
			...
			set
			{
				...
				FilteredItems = Filter(EssentialsPlayground, value);
			}
		}
		...
		public override void OnAppearing()
		{
			...
			if (!alreadyAppeared)
			{
				...
				{
					DisplayAlertAsync("Welcome to the EssentialsPlayground! This is the first time you are launching the app!");
				}
				else if (VersionTracking.IsFirstLaunchForCurrentVersion)
				{
					var count = VersionTracking.VersionHistory.Count();
					DisplayAlertAsync($"Welcome to the NEW EssentialsPlayground! You have tried {count} versions.");
				}
			}
		}

		static IEnumerable<SampleItem> Filter(IEnumerable<SampleItem> EssentialsPlayground, string filterText)
		{
			if (!string.IsNullOrWhiteSpace(filterText))
			{
				EssentialsPlayground = EssentialsPlayground.Where(s =>
				{
			...
			return EssentialsPlayground.OrderBy(s => s.Name);
		}
	}
}
